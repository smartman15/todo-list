// project list is where all projects are stored
    ...
    // function to show all projects and brief details of todo items
        // print index
        // print project name and priority
    ...
    // function to edit project name and priority
    // function takes in index as parameter
        // if index is valid
            // ask input for name
            // ask input for priority

            // set project name to input using project function
            // set project priority to input using project function
